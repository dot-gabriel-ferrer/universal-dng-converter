...
def create_test_images():
    ...
    for pos in star_positions:
        ...
        if 10 < y_pos < height-10 and 10 < x_pos < width-10:
            ...
            yy, xx = np.meshgrid(range(y_pos-5, y_pos+6), range(x_pos-5, x_pos+6), indexing='ij')
...
def test_converter():
    ...
    converter_script = Path("scripts/dng_image_converter.py")
    ...
    cmd = [
        ...
        "--input", str(test_dir / "test_gradient.fits"),
...
if __name__ == "__main__":
    ...
    if success:
        print("\n🎉 All tests passed!")
        print("\nTo manually test the converter:")
        print("  python scripts/dng_image_converter.py --input test_images/ --output manual_test/")
        print("  python scripts/dng_image_converter.py --help")
    else:
        print("\n❌ Some tests failed!")
        sys.exit(1)
