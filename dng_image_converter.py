...
Usage:
    ...
    python dng_image_converter.py --input images/ --output dng/ --format tiff --recursive
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('dng_converter.log')
    ]
)
...
class ImageConverter:
    ...
    def __init__(self, output_format: str = 'dng', quality: int = 100, 
                 bit_depth: int = 16, scaling_method: str = 'auto'):
        """
    ...
    def _load_fits_image(self, file_path: str) -> Tuple[np.ndarray, Dict]:
    ...
    def _load_standard_image(self, file_path: str) -> Tuple[np.ndarray, Dict]:
    ...
    def _load_exr_image(self, file_path: str) -> Tuple[np.ndarray, Dict]:
    ...
    def _write_dng_tiff(self, data: np.ndarray, output_path: str, metadata: Dict):
        ...
        tiff_tags = {
            ...
            'ImageDescription': f"Converted from {metadata.get('ORIGINAL_FORMAT', 'Unknown')}",
        }
    ...
    def convert_batch(self, input_dir: str, output_dir: str, recursive: bool = False) -> Dict:
        """
        ...
        for input_file in sorted(all_files):
            ...
            if recursive:
                ...
                output_file = output_dir / rel_path.parent / f"{input_file.stem}.{self.output_format}"
